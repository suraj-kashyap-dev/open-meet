                ...
                availableSuggestions.map((member) => (
                  <li key={member.id}>
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-md px-2.5 py-2 text-start text-sm transition-colors hover:bg-muted focus-visible:bg-muted focus-visible:outline-none"
                      role="option"
                    >
                      <UserAvatar user={member} size="xs" />
