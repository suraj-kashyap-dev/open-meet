...
import { AcceptInviteForm } from '@/features/web/auth/components/accept-invite-form';
    ...
    <div className="w-full max-w-sm">
      ...
      <div className="space-y-6 rounded-2xl border border-border bg-card p-7 shadow-sm">
        <header className="space-y-1">
          <h1 className="text-xl font-semibold tracking-tight">{t('accept-invite.title')}</h1>
          <p className="text-sm text-muted-foreground">{t('accept-invite.subtitle')}</p>
        </header>
