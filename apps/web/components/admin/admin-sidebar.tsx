                    ...
                    return (
                      <li key={item.href}>
                        ...
                        >
                          ...
                          {item.badge ? (
                            <span className="ml-auto rounded-full bg-muted px-1.5 py-0.5 text-[10px] font-medium uppercase">
                              {item.badge}
                            </span>
                          ) : null}
                        </span>
                    ...
                    <li key={item.href}>
                      ...
                      >
                        ...
                        {item.badge ? (
                          <span
                            className={cn(
                              'ml-auto rounded-full px-1.5 py-0.5 text-[10px] font-medium uppercase',
                              active
