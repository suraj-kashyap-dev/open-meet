...
export const meetingsApi = {
  ...
  get: (code: string, signal?: AbortSignal) => api.get<MeetingDto>(`/meetings/${encodeURIComponent(code)}`, { signal }),
