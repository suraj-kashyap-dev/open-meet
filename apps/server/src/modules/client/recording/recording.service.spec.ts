...
describe('RecordingService', () => {
  ...
  describe('start', () => {
    ...
    it('rejects when meeting is not active', async () => {
      meetings.findRawByCode.mockResolvedValue({
        id: 'm1',
        hostId: 'u1',
    ...
    it('rejects when a recording is already active', async () => {
      meetings.findRawByCode.mockResolvedValue({
        id: 'm1',
        hostId: 'u1',
        status: MeetingStatus.ACTIVE,
  ...
  describe('stop', () => {
    ...
    it('still marks STOPPING when egress stop call fails', async () => {
      meetings.findRawByCode.mockResolvedValue({
        id: 'm1',
        hostId: 'u1',
        status: MeetingStatus.ACTIVE,
  ...
  describe('handleEgressEvent', () => {
    it('completes recording on egress_ended with COMPLETE status', async () => {
    ...
    it('marks failed on egress_ended with FAILED status', async () => {
      repo.findByEgressId.mockResolvedValue(record());
    ...
    it('returns existing record without DB write on egress_started', async () => {
    ...
    it('returns null for unknown egress id', async () => {
