...
describe('GoogleOAuthService', () => {
  ...
  describe('isConfigured', () => {
    it('returns true when client id and secret are present', () => {
  ...
  describe('buildAuthorizationUrl', () => {
    it('returns a Google consent URL with required query params and stores the state', async () => {
    ...
    it('throws ServiceUnavailable when Google is not configured', async () => {
      const svc = new GoogleOAuthService(
        makeConfig({ GOOGLE_OAUTH_CLIENT_ID: undefined }),
        makeRedis().service,
      );
  ...
  describe('consumeState', () => {
    it('deletes a valid state from Redis', async () => {
      const redis = makeRedis();
  ...
  describe('exchangeCodeForProfile', () => {
    it('returns a normalized profile when Google responds with valid user info', async () => {
      const svc = new GoogleOAuthService(makeConfig(), makeRedis().service);
    ...
    it('rejects empty codes without hitting the network', async () => {
      const svc = new GoogleOAuthService(makeConfig(), makeRedis().service);
